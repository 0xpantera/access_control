...
#[starknet::component]
pub mod OwnableTwoStepComponent {
    ...
    > of super::IOwnableTwoStepCamelOnly<ComponentState<TContractState>> {
        ...
        fn initializerTwoStep(ref self: ComponentState<TContractState>, owner: ContractAddress) {
            self.initializer_two_step(owner);
        }
    }
    ...
    > of InternalTrait<TContractState> {
        ...
        fn initializer_two_step(ref self: ComponentState<TContractState>, owner: ContractAddress) {
